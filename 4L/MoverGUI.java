...
public class MoverGUI extends JPanel implements NewFrame 
{
  ...
  private void handleButtonEvent( int buttonId )
  {
    ...
    switch( buttonId )
    {
      ...
      case 2:
        ...
        _X = _snowman.getMoveX() * fasterRatio;
        _Y = _snowman.getMoveY() * fasterRatio;
        iX = Math.round( _X );
        iY = Math.round( _Y );
        _snowman.setMove( iX , iY );
        System.out.println( iX + " " + iY );
        
        break;
      case 3:
        System.out.println( "Slower" );
        _X = _snowman.getMoveX() * slowerRatio;
        _Y = _snowman.getMoveY() * slowerRatio;
        iX = Math.round( _X );
        iY = Math.round( _Y );
  ...
  private JToggleButton makeStepSizeToggle()
  {
    ...
    ///////////////////////////////////////////////////////////
    JToggleButton toggle = new JToggleButton( "Toggle minStepSize" );
