...
/** 
 * First.java: A simple 2D image of a robot.
 * 
 * @author rdb
 * 
 * Last edited:
...
{ 
    ...
    {   
        ...
        wheel2.setRoundRect( 20, 20, 40, 40, 10, 40 );
    ...
    {
        ///////////////////////////////////////////////////////////////
        // For every A-object created in the First constructor (7)
    ...
    public static void main( String[] args )
    {
        ...
        // First variables need to be "final" in order to be accessed 
        //   inside the implicitly declared anonymous class that extends 
        //   JPanel below.
        
        // Minimal test: use each constructor
        final First bot1 = new First();
        final First bot2 = new First( Color.CYAN );
        final First bot3 = new First( 75, 75 );
        bot1.getColor();
        bot2.getXLocation();
        bot3.getYLocation();
        //////////////////////////////////////////////////////////
        // Create at least 3 additional Firsts.
        //   You must use every method of First at least once, including the
        ...
        JPanel panel = new JPanel()
        {
            public void paintComponent( Graphics g )
            {
                ...
                ///////////////////////////////////////////////////
                // invoke display method of the 2nd and 3rd First
                //       objects.
                ///////////////////////////////////////////////////
